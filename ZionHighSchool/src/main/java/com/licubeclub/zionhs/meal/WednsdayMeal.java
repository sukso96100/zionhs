 ...
 * {@link WednsdayMeal.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link WednsdayMeal#newInstance} factory method to
...
//                        SRL.setRefreshing(false);
                        ...
                        Log.d("Content", lunchstring[3]+lunchkcalstring[3]);
                        Log.d("Content", dinnerstring[3]+dinnerkcalstring[3]);
                        LunchText.setText(lunchstring[3] + "\n" + lunchkcalstring[3]);
                        DinnerText.setText(dinnerstring[3] + "\n" + dinnerkcalstring[3]);
